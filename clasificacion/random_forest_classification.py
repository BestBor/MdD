...
# -*- coding: utf-8 -*-
"""
Entrena un clasificador Random Forest para predecir el cluster
asignado por K-Prototypes a partir de variables numéricas y categóricas.

Uso:
    python random_forest_classification.py datos_cluster_kprototypev1.csv \
        --test_size 0.2 \
        --seed 42 \
        --n_estimators 100 \
...
def main():
    parser = argparse.ArgumentParser(
        description="Random Forest para predecir cluster desde datos de K-Prototypes"
    )
    ...
    parser.add_argument('--n_estimators', type=int, default=100, help='Cantidad de árboles')
